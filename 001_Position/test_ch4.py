...
bond_vec = get_bond_vec(obmol_clu, oxy, metal)
...
obmol_clu.SetTitle("molecule with best H atom position")
obConversion.SetOutFormat("xyz")
...
hc_vec = get_bond_vec(obmol_met, hmet, cmet)
...
print("Write methane molecule to disk")
...
# write xyz file of the methane mokecule to disk
print("Write extended cluster to disk")
